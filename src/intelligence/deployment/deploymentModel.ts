...
export function blockedDecision(codes: string[]): DeploymentDecision {
  return { status: "BLOCKED", reason_code: codes[0], deployment_identity: null, entrypoint_assessment: null, build_plan: null, container_plan: null, environment_plan: [], health_plan: null, persistence_plan: null, provider_mapping: "PROVIDER_NEUTRAL", deployment_verification: { accepted_evidence_ids: [], missing_kinds: [] }, blockers: [...new Set(codes)].sort(), limitations: ["No deployment execution or independent verification is performed."], residual_unknowns: [], evidence_refs: [] };
}
