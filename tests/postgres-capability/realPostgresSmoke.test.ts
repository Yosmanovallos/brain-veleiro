...
describe.skipIf(!enabled)("S14H real disposable PostgreSQL smoke",()=>{
  it("executes all six production operations against the control-plane fixture",async()=>{
    ...
    const provider=new PgPostgresInspectProvider({connection_id:"s14h.real-smoke",connection_ref:"control-plane:ephemeral",allowed_schemas:["brain_s14h_smoke"],max_timeout_ms:10000,max_rows:100,max_output_bytes:65536},{resolver:{resolve:async()=>material}});
