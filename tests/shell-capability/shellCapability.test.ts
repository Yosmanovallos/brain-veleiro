...
import {
  ...
  externalSignal, permissionDeniedAtSpawn, preSpawnTimeoutProfileSmaller,
  preSpawnTimeoutRequestSmaller, remainingBudgetNotReset, stdioShape,
  stubbornGrandchildOverflow, stubbornGrandchildTimeout,
...
const invariants: Record<string, () => void | Promise<void>> = {
  ...
  "S14C-HI-028": all(positives["FX-POS-013"], stubbornGrandchildTimeout, async () => {
