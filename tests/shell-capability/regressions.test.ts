...
import { assertBoundaries, s14bAuditMaintenanceExact, s14bAuditMaintenanceMechanical } from "./audit.js";
...
it("the S14B regression-harness maintenance is exactly the authorized narrow change", async () => {
  ...
  assertBoundaries(); // additions only under S14C paths + exactly one authorized M
});
